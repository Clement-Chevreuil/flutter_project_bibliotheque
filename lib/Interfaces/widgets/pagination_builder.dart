  ...
  return SingleChildScrollView(
    ...
    child: Row(
      ...
      children: [
        ...
        if (upperBound < pageCount) buildButton(pageCount, page, setPageFunction), // Bouton de la page maximum
      ],
    ),
  );
}
...
Widget buildButton(int pageNumber, int page, Function(int) setPageFunction) {
  final isSelected = pageNumber == page; // Vérifiez si le bouton est sélectionné
  ...
  return SizedBox(
    ...
    child: TextButton(
      ...
      style: TextButton.styleFrom(
        ...
        backgroundColor: isSelected ? const Color.fromARGB(92, 33, 149, 243) : Colors.transparent, // Couleur de fond
      ),
      child: Text(
        '$pageNumber',
        style: TextStyle(
