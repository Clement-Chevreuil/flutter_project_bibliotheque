...
class _LineChartSampleState extends State<LineChartSample> {
      ...
      children: <Widget>[
        AspectRatio(
          ...
          child: Padding(
            ...
            child: LineChart(
              showAvg ? avgData() : mainData(widget.data),
            ),
          ),
        ),
        SizedBox(
  ...
  Widget bottomTitleWidgets(double value, TitleMeta meta) {
    const style = TextStyle(fontWeight: FontWeight.bold, fontSize: 10, color: Colors.blue);
    Widget text;
    switch (value.toInt()) {
      case 2:
  ...
  LineChartData mainData(List<Map<String, dynamic>> data) {
    ...
    return LineChartData(
      ...
      minX: 0,
      maxX: data.length.toDouble(), // Assuming your x-axis represents the indices of the data
      minY: 0,
      maxY: data.map<int>((map) => map['count'] as int).reduce((a, b) => a > b ? a : b).toDouble(),
      lineBarsData: [
        LineChartBarData(
          spots: spots,
          isCurved: true,
