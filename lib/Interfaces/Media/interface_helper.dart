...
import 'package:flutter_project_n1/functions/images/open_image_picker.dart';
import 'package:flutter_project_n1/functions/images/search_images.dart';
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        GestureDetector(
          onTap: () {
            openImagePicker(isImagePickerActive, picker).then((value) => setState(() {
